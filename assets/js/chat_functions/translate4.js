function translate4(toTranslate){
...
$.ajax({
    ...
    // console.log("english version: "+ data.translation);
    // console.log(data.translation);
    // telString = data.translation;
    $(".chatList").append('<li class="botText englishTrans"><div>'+data.translation+'</div></li>');
	},
